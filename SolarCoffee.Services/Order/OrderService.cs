...
namespace SolarCoffee.Services.Order
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(SolarDbContext db, ILogger<OrderService> logger, IProductService productService,
        ...
        public ServiceResponse<bool> GenerateInvoiceForOrder(SalesOrder order)
        {
            ...
            foreach (var item in order.SalesOrderItems)
            {
                ...
                var inventoryId = _inventoryService.GetByProductId(item.Quantity).Id;
